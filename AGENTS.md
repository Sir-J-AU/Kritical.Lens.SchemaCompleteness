# Kritical.Lens.SchemaCompleteness — AGENTS.md
...
|---|---|---|---|---|
| `AGENTS.md` | Kritical.Lens.SchemaCompleteness — AGENTS.md | 2026-08-01 | R1-root-entry | — |
| `README.md` | Kritical.Lens.SchemaCompleteness | 2026-07-04 | R1-root-entry | — |
| `docs/ARCHITECTURE.md` | Architecture | 2026-07-04 | R2-design-named | — |
...
Invoke-KriticalLensSweep -Root 'C:\Users\joshl\OneDrive - Kritical Pty Ltd\Github\Kritical.Lens.SchemaCompleteness'
...
Invoke-KriticalLensLanguageSweep -Root 'C:\Users\joshl\OneDrive - Kritical Pty Ltd\Github\Kritical.Lens.SchemaCompleteness'

# both families, plus a combined receipt
Invoke-KriticalLensEstateSweep -Roots 'C:\Users\joshl\OneDrive - Kritical Pty Ltd\Github\Kritical.Lens.SchemaCompleteness'

# end-of-turn gate (parser + PsLint auto-fix + PSScriptAnalyzer + Lens + corpus top-up)
& "$lens\scripts\Invoke-KritEndOfTurnGate.ps1" -Repo 'C:\Users\joshl\OneDrive - Kritical Pty Ltd\Github\Kritical.Lens.SchemaCompleteness'
```
...
| Raw git corpus (every commit, every blob) | SQL Server `.\SQLEXPRESS` database `KritLens_Kritical_Lens_SchemaCompleteness` (tables `lens.git_corpus_version` / `lens.git_corpus_blob`) | `Invoke-KritLensGitCorpusFullIngest` |
...
```powershell
& "$lens\scripts\Test-KritLensCorpusFreshness.ps1" -Only 'Kritical.Lens.SchemaCompleteness'
```
...
| --- | --- | --- |
| `Kritical.Lens.PSGraph` | YES (always runs) | 14 PowerShell file(s) — PS call graph, HOT/MEDIUM/COLD ranking |
...
| `Language.JSON` | YES — 5 file(s) | node CLI present |
...
| Markdown | 6 |
| PowerShell | 14 |
| **all tracked-ish files (excl. .git/node_modules/bin/obj/dist)** | **31** |
